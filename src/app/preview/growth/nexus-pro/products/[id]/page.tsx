    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-white">
        <div className="text-center">
          ...
          <Link href="/preview/growth/nexus-pro/products" className="text-[#d4af37] text-xs font-bold uppercase tracking-widest hover:text-white transition-colors">
            Return to Archive
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col w-full bg-[#0a0a0a] text-[#ededed] pt-32 pb-32">
      ...
      <div className="px-6 md:px-12 max-w-7xl mx-auto w-full mb-8">
        <Link href="/preview/growth/nexus-pro/products" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-white/50 hover:text-white transition-colors">
      ...
      <section className="px-6 md:px-12 max-w-7xl mx-auto w-full border-t border-white/10 pt-32 mb-32">
        ...
        {isReviewFormOpen && (
          <form onSubmit={handleReviewSubmit} className="bg-white/5 p-8 rounded-xl mb-12">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-black/50 border border-white/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#d4af37]"
                  required
                />
              </div>
              <div>
                <label className="block text-xs uppercase tracking-widest text-white/50 mb-2">Rating</label>
                <div className="flex gap-2">
                  {[1, 2, 3, 4, 5].map(rating => (
                    ...
                    >
                      <Star className={`w-6 h-6 ${reviewForm.rating >= rating ? 'fill-current' : 'text-white/20'}`} />
                    </button>
                  ))}
                </div>
              </div>
              <div>
                <label className="block text-xs uppercase tracking-widest text-white/50 mb-2">Review</label>
                <textarea 
                  value={reviewForm.content} 
                  onChange={e => setReviewForm({...reviewForm, content: e.target.value})}
                  className="w-full bg-black/50 border border-white/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#d4af37] h-32"
                  required
                />
              </div>
              <button 
                type="submit"
                className="px-8 py-3 bg-white text-black rounded-full text-xs font-bold uppercase tracking-widest hover:bg-[#d4af37] hover:text-white transition-colors"
              >
                Submit Review
              </button>
            </div>
