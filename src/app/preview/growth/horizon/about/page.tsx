      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          <h1 className="font-cormorant text-5xl md:text-7xl font-light tracking-tight leading-[1.1] max-w-4xl text-[#111]">
            We believe that <span className="italic font-medium">aesthetic excellence</span> is not a luxury, but a fundamental requirement for the modern digital experience.
          </h1>
        </motion.div>
          ...
          <div className="pt-12 md:pt-48">
            ...
            >
              ...
              <p className="font-outfit text-sm font-light leading-loose text-black/60 mb-12">
                Horizon was founded on a singular principle: digital assets should be crafted with the same meticulous attention to detail as physical luxury goods. We reject the generic, the templated, and the uninspired.
              </p>
              <p className="font-outfit text-sm font-light leading-loose text-black/60 mb-12">
                Every UI kit, typography pairing, and motion asset in our archive is designed to elevate your brand from merely functional to profoundly memorable. We exist for the creators who push boundaries.
              </p>
              
              <Link href="/preview/growth/horizon/products" className="group inline-flex items-center gap-4 pointer-events-auto" style={{ cursor: "none" }}>
