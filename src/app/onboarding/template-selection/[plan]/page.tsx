...
const getDummyTemplates = (plan: string) => {
  if (plan === "empire") {
    return [
      { name: "Aero", category: "3D Monolithic", img: "/aero-ss.png", span: "col-span-1 md:col-span-2 row-span-2", delay: 0.1, href: "/templates/aero" },
      { name: "Obsidian", category: "Neo-Brutalist", img: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=2940&auto=format&fit=crop", span: "col-span-1 row-span-1", delay: 0.2, href: "/templates/obsidian" },
    ...
    return [
      { name: "Nexus Pro", category: "Tech & Gadgets", img: "/screenshots/growth_nexus_pro.png", span: "col-span-1 md:col-span-2 row-span-2", delay: 0.1, href: "/templates/nexus-pro" },
      { name: "Velocity", category: "Dark Cyberpunk", img: "/screenshots/growth_velocity.png", span: "col-span-1 row-span-1", delay: 0.2, href: "/templates/velocity" },
      { name: "Quantum", category: "Animated", img: "/screenshots/growth_quantum.png", span: "col-span-1 row-span-1", delay: 0.3, href: "/templates/quantum" },
      { name: "Horizon", category: "Digital", img: "/screenshots/growth_horizon.png", span: "col-span-1 md:col-span-3 row-span-2", delay: 0.4, href: "/templates/horizon" }
    ];
  } else {
    return [
      { name: "Minimalist", category: "Fashion", img: "/screenshots/starter_minimalist.png", span: "col-span-1 md:col-span-2 row-span-2", delay: 0.1, href: "/templates/minimalist" },
      { name: "Essence", category: "Clean Skincare", img: "/screenshots/starter_essence.png", span: "col-span-1 row-span-1", delay: 0.2, href: "/templates/essence" },
      { name: "Origin", category: "Soft Ceramics", img: "/screenshots/starter_origin.png", span: "col-span-1 row-span-1", delay: 0.3, href: "/templates/origin" },
      { name: "Canvas", category: "Editorial Furniture", img: "/screenshots/starter_canvas.png", span: "col-span-1 md:col-span-3 row-span-2", delay: 0.4, href: "/templates/canvas" }
    ];
  }
};
