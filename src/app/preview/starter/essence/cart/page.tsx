                ...
                {items.map((item) => (
                  ...
                  >
                    <div className="col-span-1 md:col-span-6 flex gap-6 items-center">
                      <Link href={`/preview/starter/essence/products/${item.product.id}`}>
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="text-sm text-[#4A3F35]/60 italic font-serif">${item.product.price.toFixed(2)}</div>
                        <button 
            ...
            <div className="w-full lg:w-1/3">
              <div className="bg-[#E3D8C8]/30 p-8 md:p-10 sticky top-32">
                ...
                <div className="flex justify-between items-end mb-10 text-[#4A3F35]">
                  ...
                  <span className="font-serif text-3xl italic">${totalPrice.toFixed(2)}</span>
                </div>
                
                <Link href="/preview/starter/essence/checkout" className="w-full flex items-center justify-center bg-[#4A3F35] text-[#F3EDE2] py-5 text-xs uppercase tracking-[0.2em] font-bold hover:bg-[#332B25] transition-colors mb-4">
                  Proceed to Checkout
                </Link>
