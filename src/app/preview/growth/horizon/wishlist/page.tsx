...
export default function HorizonWishlist() {
  const { wishlist, toggleWishlist, addToCart } = useHorizon();
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12">
        ...
        {wishlist.length === 0 ? (
          <div className="py-32 flex flex-col items-center justify-center border border-black/5 bg-white shadow-[0_20px_40px_rgba(0,0,0,0.02)]">
             ...
             <Link href="/preview/growth/horizon/products" className="inline-flex items-center gap-4 group pointer-events-auto cursor-none">
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="font-outfit text-[10px] font-medium text-black/40 tracking-[0.2em] uppercase mb-6">${product.price.toFixed(2)}</p>
                  </div>
