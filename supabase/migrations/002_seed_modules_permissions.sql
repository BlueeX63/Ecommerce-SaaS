...
SELECT seed_permissions('MOD_INVENTORY', '[
...
-- Orders Permissions
SELECT seed_permissions('MOD_ORDERS', '[
...
SELECT seed_permissions('MOD_CUSTOMERS', '[
...
-- Dealers Permissions
SELECT seed_permissions('MOD_DEALERS', '[
...
SELECT seed_permissions('MOD_INVOICES', '[
...
SELECT seed_permissions('MOD_PAYMENTS', '[
...
SELECT seed_permissions('MOD_SETTINGS', '[
...
SELECT seed_permissions('MOD_USERS', '[
