...
export default function QuantumCheckoutPage() {
  const { cart, clearCart, setIsCartOpen, appliedCoupon, discountAmount, couponError, applyCoupon, removeCoupon } = useQuantum();
  ...
  const shipping = cartTotal > 0 ? (cartTotal > 500 ? 0 : 50) : 0;
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#F9F9FB] text-[#121212] p-6">
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            <Link 
              href="/preview/growth/quantum/profile"
            ...
            <Link 
              href="/preview/growth/quantum/products"
  ...
  if (cart.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#F9F9FB] text-[#121212] font-inter">
        ...
        <Link href="/preview/growth/quantum/products" className="text-[#111111] font-bold underline hover:text-gray-600 transition-colors">Return to Gallery</Link>
      </div>
    );
  }
      ...
      <section className="px-6 md:px-12 max-w-[1600px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
        ...
        <div className="lg:col-span-7">
          <form onSubmit={handleCheckout} className="space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-2 p-1 bg-gray-50 rounded-xl border border-gray-100">
                  <button 
                    ...
                    className={`py-3 text-xs font-bold uppercase tracking-wider rounded-lg transition-all font-inter ${paymentMethod === 'credit' ? 'bg-white text-[#111111] shadow-sm' : 'text-gray-400 hover:text-gray-600'}`}
                  >
                    Credit Card
                  </button>
                  <button 
            ...
            >
              {isProcessing ? 'Processing...' : paymentMethod === 'cod' ? 'Confirm Order' : `Pay $${finalTotal.toFixed(2)}`}
            </button>
          </form>
        </div>
        ...
        <div className="lg:col-span-5">
          <div className="bg-white border border-gray-100 p-8 rounded-3xl sticky top-32 shadow-sm">
            ...
            <div className="space-y-4 text-sm font-medium border-t border-gray-100 pt-6 mb-6 font-inter">
              ...
              <div className="flex justify-between items-center text-gray-500">
                <span>Shipping</span>
                <span className="text-[#111111]">{shipping === 0 ? 'Free' : `$${shipping.toFixed(2)}`}</span>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center pt-6 border-t border-gray-100 font-inter">
              ...
              <span className="text-3xl font-bold text-[#111111] font-playfair">${finalTotal.toFixed(2)}</span>
            </div>
          </div>
        </div>
