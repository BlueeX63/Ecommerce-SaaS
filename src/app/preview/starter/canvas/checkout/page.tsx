...
export default function CanvasCheckoutPage() {
  const { items, cartTotal, clearCart, appliedCoupon, applyCoupon, removeCoupon, discountAmount, couponError } = useCart();
    ...
    return (
      <div className="w-full bg-black min-h-screen pt-32 pb-32 px-6 md:px-12 text-white">
        <div className="max-w-[800px] mx-auto">
          <Link href="/preview/starter/canvas/cart" className="flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-white/50 hover:text-white transition-colors mb-12 w-fit">
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <label htmlFor="mobile" className="text-[10px] font-mono tracking-widest uppercase text-white/80">Mobile Number</label>
                <input 
                  type="tel" 
                  id="mobile" 
                  required
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
              ...
              <div className="space-y-6">
                <h3 className="text-[10px] font-mono tracking-widest uppercase text-white/50 border-b border-white/20 pb-4">Payment Method</h3>
                <div className="flex items-center gap-4">
                  <div className="w-5 h-5 border border-white flex items-center justify-center">
                    <div className="w-2.5 h-2.5 bg-white"></div>
                  </div>
                  <span className="font-mono text-sm">Cash on Delivery (COD)</span>
                </div>
                <p className="font-mono text-[10px] text-white/40 mt-4 leading-loose uppercase tracking-widest">
