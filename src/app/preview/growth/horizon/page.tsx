    ...
    <div ref={containerRef} className="relative h-screen flex flex-col items-center justify-center overflow-hidden bg-[#FAFAFA] w-full">
      ...
      <div className="absolute inset-0 flex flex-col justify-center pointer-events-none z-0">
        <motion.div style={{ y: yText }}>
           <KineticMarquee text="AESTHETIC" direction={1} />
           <KineticMarquee text="INTELLIGENCE" direction={-1} />
        </motion.div>
      </div>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-20">
        ...
        >
          ...
          <h1 className="font-cormorant text-7xl md:text-9xl font-light tracking-tight leading-none text-[#111] mix-blend-difference">
            Pure <span className="italic font-medium">Vision</span>.
          </h1>
        </motion.div>
      </div>
      ...
      >
        <Link href="/preview/growth/horizon/products" className="group flex items-center gap-4 cursor-none pointer-events-auto">
...
function ProductCard({ product, index }: { product: any, index: number }) {
  ...
  return (
    ...
    >
      <Link href={`/preview/growth/horizon/products/${product.id}`} className="block cursor-none pointer-events-auto">
      ...
      <div className="flex justify-between items-start">
        ...
        <span className="font-outfit font-medium text-[#111]/80">${product.price.toFixed(2)}</span>
      </div>
    </motion.div>
  );
}
  ...
  return (
    <div ref={containerRef} className="bg-[#FAFAFA] min-h-[200vh]">
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-12 border-b border-black/5 pb-12">
            <div className="overflow-hidden">
              ...
              >
                Curated <span className="italic font-medium">Selection</span>
              </motion.h2>
            </div>
            <Link href="/preview/growth/horizon/products" className="group inline-flex items-center gap-4 cursor-none pointer-events-auto">
      ...
      <section className="py-40 bg-white text-center relative overflow-hidden border-t border-black/5">
        ...
        >
          <span className="font-outfit text-[10px] uppercase tracking-[0.4em] text-black/40 font-medium mb-12 block">Our Ethos</span>
          <h2 className="font-cormorant text-4xl md:text-6xl font-light leading-snug mb-16 text-[#111]">
            ...
            <span className="italic font-medium">Design is how it works.</span>"
          </h2>
          <Link href="/preview/growth/horizon/about" className="inline-flex items-center gap-4 group cursor-none pointer-events-auto">
