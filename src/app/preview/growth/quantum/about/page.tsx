      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Beyond Form. <br/> <span className="text-[#111111] italic">Beyond Function.</span>
            </motion.h1>
            ...
            >
              <p>
                Quantum was founded on a singular premise: that the objects we interact with every day should not merely serve a purpose, but should elevate our consciousness. 
              </p>
              <p>
                We collaborate with visionary designers and avant-garde artists to blur the lines between conceptual art and functional homeware. Every artifact in our collection is a testament to what happens when imagination is unconstrained by traditional manufacturing limitations.
              </p>
              <p>
                We don't sell furniture. We curate experiences.
              </p>
            </motion.div>
          </div>
