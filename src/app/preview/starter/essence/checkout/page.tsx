    ...
    return (
      <div className="w-full bg-[#F3EDE2] min-h-screen pt-12 pb-32 px-6 md:px-12 text-[#4A3F35]">
        <div className="max-w-[600px] mx-auto">
          <Link href="/preview/starter/essence/cart" className="flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-[#4A3F35]/50 hover:text-[#4A3F35] transition-colors mb-12 w-fit">
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="mobile" className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#4A3F35]/80">Mobile Number</label>
                <input 
                  type="tel" 
                  id="mobile" 
                  required
        ...
        <div className="max-w-[600px] mx-auto">
          ...
          >
            ...
            <div className="bg-[#E3D8C8]/30 p-6 mb-10">
              <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#4A3F35]/70 border-b border-[#4A3F35]/10 pb-3 mb-4">Payment Method</h3>
              <div className="flex items-center gap-3">
                <div className="w-4 h-4 rounded-full border border-[#4A3F35] flex items-center justify-center">
                  <div className="w-2 h-2 bg-[#4A3F35] rounded-full"></div>
                </div>
                <span className="text-sm font-medium text-[#4A3F35]">Cash on Delivery (COD)</span>
              </div>
              <p className="text-xs text-[#4A3F35]/50 mt-3 pl-7 leading-relaxed">Payment will be collected upon delivery of your items.</p>
            </div>
