  ...
  if (!product) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center bg-[#F3EDE2]">
        ...
        <Link href="/preview/starter/essence/products" className="text-xs uppercase tracking-[0.2em] border-b border-[#4A3F35] pb-1 text-[#4A3F35] hover:text-[#A69684] hover:border-[#A69684] transition-colors">
          Return to Shop
        </Link>
      </div>
    );
