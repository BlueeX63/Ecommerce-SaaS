...
import { ShoppingBag, Heart, Menu, X, ArrowRight, User, Infinity } from "lucide-react";
...
function QuantumNavigation() {
  const { cart, wishlist, isCartOpen, setIsCartOpen, clearCart } = useQuantum();
  ...
  const navLinks = [
    { name: "Collection", href: "/preview/growth/quantum/products" },
    { name: "Philosophy", href: "/preview/growth/quantum/about" },
    { name: "Contact", href: "/preview/growth/quantum/contact" }
  ];
    ...
    <>
      ...
      >
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 flex items-center justify-between">
          ...
          <Link href="/preview/growth/quantum" className="flex items-center gap-3 group z-50 relative">
          ...
          <div className="flex items-center gap-6 z-50 relative">
            <Link href="/preview/growth/quantum/profile" className="hidden md:flex relative group p-2">
              <User className="w-5 h-5 text-gray-500 group-hover:text-[#111111] transition-colors" />
            </Link>

            <Link href="/preview/growth/quantum/wishlist" className="hidden md:flex relative group p-2">
          ...
          >
            <div className="flex flex-col items-center gap-8 text-3xl font-bold text-[#121212] mt-12">
              ...
              <div className="flex gap-8 mt-12">
                <Link href="/preview/growth/quantum/profile" onClick={() => setIsMobileMenuOpen(false)}>
                  <User className="w-8 h-8 text-gray-400" />
                </Link>
                <Link href="/preview/growth/quantum/wishlist" onClick={() => setIsMobileMenuOpen(false)} className="relative">
            ...
            >
                      ...
                      >
                        ...
                        <div className="flex-1 flex flex-col justify-between py-1">
                          ...
                          <div className="flex justify-between items-center mt-4">
                            <p className={`font-medium ${inter.className}`}>${item.price.toFixed(2)}</p>
              ...
              {cart.length > 0 && (
                <div className="p-6 border-t border-gray-100 bg-gray-50/50">
                  ...
                  <Link 
                    href="/preview/growth/quantum/checkout"
                    onClick={() => setIsCartOpen(false)}
      ...
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-24 mb-16">
          <div className="md:col-span-2">
            <Link href="/preview/growth/quantum" className="flex items-center gap-2 mb-8">
              <Infinity className="w-6 h-6 text-[#111111]" />
              <span className={`text-2xl font-bold tracking-tight text-[#121212] ${playfair.className}`}>Quantum</span>
            </Link>
            <p className={`text-gray-500 max-w-md leading-relaxed ${inter.className}`}>
              Designing the future of living spaces. We merge conceptual art with functional everyday objects to create a truly transcendent environment.
            </p>
          </div>
          <div>
            ...
            <ul className={`space-y-4 text-gray-500 ${inter.className}`}>
              <li><Link href="/preview/growth/quantum/products" className="hover:text-[#111111] transition-colors">Collection</Link></li>
              <li><Link href="/preview/growth/quantum/about" className="hover:text-[#111111] transition-colors">Philosophy</Link></li>
              <li><Link href="/preview/growth/quantum/contact" className="hover:text-[#111111] transition-colors">Contact</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className={`pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400 ${inter.className}`}>
          <p>© 2026 Quantum Design Studio. All rights reserved.</p>
          <div className="flex gap-6">
            <Link href="#" className="hover:text-[#121212] transition-colors">Instagram</Link>
            <Link href="#" className="hover:text-[#121212] transition-colors">Twitter</Link>
          </div>
        </div>
      </div>
