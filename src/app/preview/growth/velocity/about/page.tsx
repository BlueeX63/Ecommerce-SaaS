    ...
    <div className="bg-[#050505] min-h-screen text-white overflow-hidden relative" ref={containerRef}>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden z-10">
        ...
        <div className="text-center relative z-20 px-6">
          ...
          >
            We are the architects of the future. We don't just design clothes; we engineer armor for the digital age.
          </motion.p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-white/70 font-space leading-relaxed">
              Velocity was born from a singular obsession: to push the boundaries of what the human body can achieve when augmented with cutting-edge textiles and integrated tech.
            </p>
            <p className="text-white/70 font-space leading-relaxed">
              Our materials are sourced from aerospace manufacturers, featuring nano-carbon weaves that adapt to your environment, keeping you cool in the neon-lit streets and warm in the upper atmosphere.
            </p>
