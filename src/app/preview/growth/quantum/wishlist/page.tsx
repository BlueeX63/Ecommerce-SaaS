            ...
            <AnimatePresence>
              {wishlist.map((item) => (
                ...
                >
                  ...
                  <Link href={`/preview/growth/quantum/products/${item.id}`} className="block relative aspect-square rounded-2xl overflow-hidden bg-gray-100 mb-6">
                    <img 
                      src={item.image} 
                      alt={item.name}
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <Link href={`/preview/growth/quantum/products/${item.id}`}>
